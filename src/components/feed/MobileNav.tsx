...
export default function MobileNav() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[1030] border-t border-border-input bg-[var(--card-bg)] lg:hidden">
      <ul className="flex items-center justify-around py-2">
        {/* Home */}
        <li>
          <Link href="/feed" className="flex flex-col items-center p-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 24 27">
              <path className="fill-primary stroke-primary" strokeWidth="1.5" d="M1 13.042c0-2.094 0-3.141.431-4.061.432-.92 1.242-1.602 2.862-2.965l1.571-1.321C8.792 2.232 10.256 1 12 1c1.744 0 3.208 1.232 6.136 3.695l1.572 1.321c1.62 1.363 2.43 2.044 2.86 2.965.432.92.432 1.967.432 4.06v6.54c0 2.908 0 4.362-.92 5.265-.921.904-2.403.904-5.366.904H7.286c-2.963 0-4.445 0-5.365-.904C1 23.944 1 22.49 1 19.581v-6.54z" />
        ...
        {/* Friends */}
        <li>
          <span className="flex cursor-pointer flex-col items-center p-2 opacity-60">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="18" fill="none" viewBox="0 0 27 20">
        ...
        <li>
          <span className="flex cursor-pointer flex-col items-center p-2 opacity-60">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 25 27">
