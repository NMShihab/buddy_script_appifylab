...
export default function CreatePost({ onPostCreated }: CreatePostProps) {
  ...
  return (
    <div className="mb-4 rounded-sm bg-[var(--card-bg)] p-6 transition-all duration-200">
      ...
      <div className="mb-4 flex gap-3">
        ...
        <div className="flex-1">
          <textarea
            ...
            rows={3}
            className="w-full rounded-sm border-none bg-transparent text-sm leading-relaxed text-text-body outline-none placeholder:text-text-muted"
          />
        </div>
      </div>
      ...
      {/* Action bar */}
      <div className="flex flex-wrap items-center justify-between border-t border-border-input pt-4">
        <div className="flex flex-wrap items-center gap-1">
          ...
          <button
            type="button"
            className="hidden items-center gap-1.5 rounded px-3 py-1.5 text-sm font-medium text-text-muted transition-colors hover:bg-surface-input sm:flex"
          >
