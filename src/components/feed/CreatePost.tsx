      ...
      <div className="mb-4 flex items-start gap-3">
        ...
        <div className="relative flex-1">
          <textarea
            ...
            rows={3}
            className="w-full rounded-[6px] border border-border-input bg-transparent px-3 py-3 text-sm leading-relaxed text-text-body outline-none transition-colors focus:border-primary"
          />
          {!content && (
            <label className="pointer-events-none absolute left-3 top-3 flex items-center gap-1.5 text-sm text-text-muted">
              Write something ...
